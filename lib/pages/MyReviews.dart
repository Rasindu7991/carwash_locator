...
class _MyReviewsState extends State<MyReviews> {
  ...
  createData() {
    ...
    DocumentReference ds = Firestore.instance.collection('reviews').document(name);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body:StreamBuilder(
        stream: Firestore.instance.collection('reviews').where("shopid", isEqualTo: widget.shopid).snapshots(),
